                    ...
                    <div class="example-wrap">
                        <div class="example">
                            ...
                            <div class="modal-body form-horizontal">
                                <div class="col-md-6">
                                    <label class="col-sm-2 control-label">图片增长：</label>
                                    <div  class="col-sm-10">
                                        <div id="photogrowth" style="height:400px;"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="col-sm-2 control-label">用户增长：</label>
                                    <div  class="col-sm-10">
                                        <div id="usergrowth" style="height:400px;"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="col-sm-2 control-label">相册增长：</label>
                                    <div  class="col-sm-10">
                                        <div id="photoalbumgrowth" style="height:400px;"></div>
                                    </div>
                                </div>
                                <!-- <div class="col-md-6">
                                    <label class="col-sm-2 control-label">车辆统计：</label>
                                    <div  class="col-sm-10">
                                        <div id="main1" style="height:400px;"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="col-sm-2 control-label">用户统计：</label>
                                    <div  class="col-sm-10">
                                        <div id="main2" style="height:400px;"></div>
                                    </div>
                                </div> -->
                                <!-- <div class="col-md-6">
                                    <label class="col-sm-2 control-label">新增注册人数统计：</label>
                                    <div  class="col-sm-10">
                                        <div id="main3" style="height:400px;"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="col-sm-2 control-label">新增车辆数统计：</label>
                                    <div  class="col-sm-10">
                                        <div id="main4" style="height:400px;"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <label class="col-sm-1 control-label">车辆审核：</label>
                                    <div  class="col-sm-10">
                                    </div>
                                </div> -->
                            </div>
