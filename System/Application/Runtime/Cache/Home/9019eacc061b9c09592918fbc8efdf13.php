            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="form-horizontal m-t" id="commentForm">
                        <h2><div  class="col-sm-2"></div>添加子科室</h2>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-3">
                                ...
                                <a href="/Department/lists"><button class="btn btn-white" type="button">取消</button></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.status){
                    ...
                    alert('添加成功');
                    window.location="/Department/lists";
                }else{
                    alert(data.message)
                }
            }
