                            ...
                            <table data-toggle="table" class="table table-hover"  data-mobile-responsive="true">
                                <thead>
                                    <tr>
                                        ...
                                        <th align="center">优惠券标题</th>
                                        <th align="center">优惠券内容</th>
                                        <th align="center">使用状态</th>
                                        <th align="center">优惠券开始日</th>
                                        <th align="center">优惠券结束</th>
                                        <th align="center">二维码</th>
                                        <th align="center">无序码</th>
                                ...
                                <tbody>
                                   <?php if(is_array($results)): $i = 0; $__LIST__ = $results;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr target="sid_user" rel="<?php echo ($vo['id']); ?>">
                                        ...
                                        <td><?php echo (date("Y-m-d H:i:s",$vo["effective_start_date"])); ?></td>
                                        <td><?php echo (date("Y-m-d H:i:s",$vo["effective_end_date"])); ?></td>
                                        <td><?php echo ($vo["code_url"]); ?></td>
                                        <td><?php echo ($vo["code"]); ?></td>
                                        <td><?php echo (date("Y-m-d H:i:s",$vo["create_time"])); ?></td>
                                        <td>
                                            &nbsp;&nbsp;&nbsp;
                                            <a href="/Coupon/raedit?id=<?php echo ($vo['id']); ?>">编辑</a>
