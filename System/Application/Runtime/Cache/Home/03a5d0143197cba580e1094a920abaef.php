                        ...
                        <div class="example">
                            <div class="btn-group" role="group">
                                <a href="/Broadcastimg/adds" class="btn btn-outline btn-default">
                                    <i class="glyphicon glyphicon-plus" aria-hidden="true"></i> 添加轮播图
                                </a>
                            </div>
                            <h1>轮播图管理</h1>
                            <table data-toggle="table" class="table table-hover"  data-mobile-responsive="true">
                                ...
                                <tbody>
                                   <?php if(is_array($results)): $i = 0; $__LIST__ = $results;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr target="sid_user" rel="<?php echo ($vo['id']); ?>">
                                        ...
                                        <td>
                                            <?php
 $urls=json_decode($vo['img'],true); foreach ($urls as $key => $value) { ?>
                                        ...
                                        <td>
                                            &nbsp;&nbsp;&nbsp;
                                            <a href="/Broadcastimg/raedit?id=<?php echo ($vo['id']); ?>">编辑</a>&nbsp;&nbsp;&nbsp;
