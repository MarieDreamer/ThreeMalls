                    ...
                    <div class="example-wrap">
                        <div class="example">
                            <div class="btn-group" role="group">
                                <a href="/Activities/adds" class="btn btn-outline btn-default">
                                    <i class="glyphicon glyphicon-plus" aria-hidden="true"></i> 添加活动
                                </a>
                            </div>
                            <h1>活动管理</h1>
                            <table data-toggle="table" class="table table-hover"  data-mobile-responsive="true">
                                <thead>
                                    <tr>
                                        ...
                                        <th align="center">其他用户id</th>
                                        <th align="center">活动类型</th>
                                        <th align="center">活动名字</th>
                                        <th align="center">首页图片</th>
                                        <th align="center">用户人数</th>
                                        <th align="center">图片数</th>
                                ...
                                <tbody>
                                   <?php if(is_array($results)): $i = 0; $__LIST__ = $results;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr target="sid_user" rel="<?php echo ($vo['id']); ?>">
                                        ...
                                        <td><?php echo ($vo['other_user_id']); ?></td>
                                        <td><?php echo ($vo['album_class']); ?></td>
                                        <td><?php echo ($vo['name']); ?></td>
                                        <td><?php echo ($vo['index_photo']); ?></td>
                                        <td><?php echo ($vo["person_num"]); ?></td>
                                        <td><?php echo ($vo["photo_num"]); ?></td>
                                        ...
                                        <td>
                                            ...
                                            &nbsp;&nbsp;&nbsp;
                                            <a href="/Activities/raedit?id=<?php echo ($vo['id']); ?>">编辑</a>&nbsp;&nbsp;&nbsp;
                                            <a href="/Activities/photoview?id=<?php echo ($vo['id']); ?>">查看活动图片</a>&nbsp;&nbsp;&nbsp;
                                            <!-- <a title="编辑"00" href="/MerchantsAdd/edit/id/<?php echo ($vo["id"]); ?>" class="btnEdit">审核状态更改</a>&nbsp;&nbsp;&nbsp; -->
                                            <!-- <a title="编辑"00" href="/MerchantsAdd/edits/id/<?php echo ($vo["id"]); ?>" class="btnEdit">详细内容更改</a>&nbsp;&nbsp;&nbsp; -->
