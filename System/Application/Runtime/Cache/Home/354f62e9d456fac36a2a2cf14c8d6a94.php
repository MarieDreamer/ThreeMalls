                                ...
                                <tbody>
                                   <?php foreach ($results as $key => $value) { ?>
                                    <tr target="sid_user" rel="<?php echo $value['id'];?>">
                                        ...
                                        <td><?php if($value['guess_content']==1){ echo '猜单'; } else if($value['guess_content']==2){ echo '猜双'; } ?></td>
                                        <td><?php if($value['is_free']==0){ echo '未开奖'; }else if($value['is_free']==1){ echo '恭喜免单'; }else if($value['is_free']==2){ echo '未免单'; } ?></td>
